              ...
              <div className='md:flex items-center justify-between md:gap-8'>
                  ...
                  <div className='w-full md:w-1/2 mb-5 md:mb-0'>
                    <h2 className='text-xl leading-10 text-white mb-4 md:text-xl '>
                      Do you want to questions for sistem absensi ?
                    </h2>
                  ...
                  <div className='w-full md:1/2'>
                      ...
                      <div className=' flex items-center gap-4 flex-wrap md:gap-4 md:justify-center'>
                        ...
                        <span>
                                  <Link to='/' className='text-lg text-gray-300 hover:text-primary hover:border-b-2  hover:border-b-primary '>About</Link> |
                        </span>
                        <span>
                                  <Link to='/' className='text-lg text-gray-300 hover:text-primary hover:border-b-2  hover:border-b-primary '>Contact</Link> |
                        </span>
                        <span>
                                  <Link to='/' className='text-lg text-gray-300 hover:text-primary hover:border-b-2  hover:border-b-primary '>Privacy policy</Link> |
                        </span>
